...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var sumOfThreeMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + sumOfThree[0] + '.';
  var productOfThreeMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productOfThree[0] + '.';

  return[sumOfThree[0], productOfThree[0], sumOfThreeMessage, productOfThreeMessage];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  do {
    productLoop = multiply(productLoop, dynamicArray[i++])[0];
